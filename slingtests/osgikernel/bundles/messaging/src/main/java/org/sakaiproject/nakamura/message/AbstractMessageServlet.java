...
import static org.sakaiproject.nakamura.api.message.MessageConstants.MESSAGE_OPERATION;
...
public abstract class AbstractMessageServlet extends AbstractVirtualPathServlet {
   ...
   * {@inheritDoc}
   * 
   * @see org.sakaiproject.nakamura.resource.AbstractVirtualPathServlet#hashRequest(org.apache.sling.api.SlingHttpServletRequest,
