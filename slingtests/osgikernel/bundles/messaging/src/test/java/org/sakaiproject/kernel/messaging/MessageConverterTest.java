...
public class MessageConverterTest {
  ...
  private MessagingService msgServ;
  private Message msg;

  @Before
  public void setUp() {
    msgServ = createMock(MessagingService.class);

    msgConverter = new JsonMessageConverter(msgServ);
  ...
  public void convertMessageWithParts() throws Exception {
    ...
    msg.setText(body);
    // add first part
    Message part1 = msgServ.createMessage();
  ...
  public void convertMessageWithNestedParts() throws Exception {
    ...
    msg.addAttachment("application/file", url2);
    // add nested part
    Message part3 = msgServ.createMessage();
    URL url3 = writeTempFile("test3");
    part3.setBody(url3);
    Message part4 = msgServ.createMessage();
