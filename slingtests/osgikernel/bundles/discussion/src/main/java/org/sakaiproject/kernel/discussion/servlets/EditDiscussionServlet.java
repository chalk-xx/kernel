 ...
 * @scr.property name="sling.servlet.selectors" values.0="edit"
 ...
 */
public class EditDiscussionServlet extends SlingAllMethodsServlet {

  /**
   * 
   */
  private static final long serialVersionUID = -6365099051194250234L;
  ...
  protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServletException, IOException {
    try {
      discussionManager.edit(request.getParameterMap(), request.getResource());
