 ...
 */
public abstract class DynamicProtectedItemModifier {

    private static final int DEFAULT_PERM_CHECK = -1;
    private final int permission;

    protected DynamicProtectedItemModifier() {
        this(DEFAULT_PERM_CHECK);
    }

    protected DynamicProtectedItemModifier(int permission) {
        Class cl = getClass();
        if (!(cl.equals(UserManagerImpl.class) ||
              ...
              cl.equals(org.apache.sling.jcr.jackrabbit.server.impl.security.standard.ACLEditor.class))) {
