...
package org.sakaiproject.kernel2.osgi.sessiontest2;
 ...
 * @scr.property name="sling.servlet.paths" value="/test/sessiontest2"
 */
public class SessionTest2 extends HttpServlet {

  private static final Logger LOG = LoggerFactory.getLogger(SessionTest2.class);
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException,
    ...
    writer.write("<html><head><title>Test</title></head><body><h1>Test2</h1><p>SessionID: " + req.getSession().getId()
