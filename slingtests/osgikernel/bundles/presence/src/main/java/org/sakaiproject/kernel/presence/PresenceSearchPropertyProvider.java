...
/**
 * Provides properties to process the search for presence data
 * 
 * @scr.component immediate="true" label="PresenceSearchPropertyProvider"
 *                description="Formatter for presence search results"
 * @scr.property name="service.vendor" value="The Sakai Foundation"
 * @scr.property name="sakai.search.provider" value="Presence"
 * @scr.service interface="org.sakaiproject.kernel.api.search.SearchPropertyProvider"
 */
public class PresenceSearchPropertyProvider implements SearchPropertyProvider {
  ...
  public void loadUserProperties(SlingHttpServletRequest request,
    ...
    propertiesMap.put(PresenceService.PRESENCE_SEARCH_PROP, 
        ISO9075.encodePath( PathUtils.toInternalHashedPath(path, user, "") ));    
  }
