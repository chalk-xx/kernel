...
import org.sakaiproject.kernel.api.activity.AbstractActivityRoute;
...
public class SiteActivityRouter implements ActivityRouter {
   ...
   * {@inheritDoc}
   * 
   * @see org.sakaiproject.kernel.api.activity.ActivityRouter#getPriority()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.sakaiproject.kernel.api.activity.ActivityRouter#route(javax.jcr.Node,
   *      java.util.List)
   */
