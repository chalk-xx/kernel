 ...
 */
package org.sakaiproject.kernel.docproxy;
 ...
 * Sling protocol.
 */
@SlingServlet(resourceTypes = { "sling/nonexistantresource" }, selectors = { "create" }, methods = { "POST" }, generateComponent = true, generateService = true)
