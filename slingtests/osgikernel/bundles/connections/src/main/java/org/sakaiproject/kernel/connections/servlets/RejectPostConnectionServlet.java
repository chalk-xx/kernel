 ...
 */
public abstract class RejectPostConnectionServlet extends
    AbstractPostConnectionServlet {

  private static final long serialVersionUID = 111L;

  public RejectPostConnectionServlet() {
    setOPERATION(ConnectionConstants.ConnectionOperations.REJECT);
  }
