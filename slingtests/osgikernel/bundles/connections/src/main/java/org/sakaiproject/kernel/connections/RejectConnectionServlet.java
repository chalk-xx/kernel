...
/**
 * Reject a connection request, informing the requestor
 * @scr.component metatype="no" immediate="true"
 * @scr.service interface="javax.servlet.Servlet"
 * @scr.property name="sling.servlet.resourceTypes" values="sakai/connectionstore"
 * @scr.property name="sling.servlet.methods" value="POST"
 * @scr.property name="sling.servlet.selectors" value="reject"
 */
public class RejectConnectionServlet extends SlingAllMethodsServlet {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(RejectConnectionServlet.class);
