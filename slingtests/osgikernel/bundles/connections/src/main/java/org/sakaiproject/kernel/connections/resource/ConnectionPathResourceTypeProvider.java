 ...
 */
public class ConnectionPathResourceTypeProvider implements PathResourceTypeProvider {

  private static final Logger LOGGER = LoggerFactory
      .getLogger(ConnectionPathResourceTypeProvider.class);
    ...
    try {
      ...
      while (!"/".equals(n.getPath())) {
        if (n.hasProperty(JcrResourceConstants.SLING_RESOURCE_TYPE_PROPERTY)
            && SAKAI_CONNECTIONSTORE_RT.equals(n.getProperty(
