...
/**
 * Blocks a connection from further connection request.
 * 
 * @scr.component metatype="no" immediate="true"
 * @scr.service interface="javax.servlet.Servlet"
 * @scr.property name="sling.servlet.resourceTypes" values="sakai/connectionstore"
 * @scr.property name="sling.servlet.methods" value="POST"
 * @scr.property name="sling.servlet.selectors" value="block"
 */
public class BlockConnectionServlet extends SlingAllMethodsServlet {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(BlockConnectionServlet.class);
