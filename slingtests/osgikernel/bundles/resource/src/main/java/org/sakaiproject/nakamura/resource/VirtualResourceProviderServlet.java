    ...
    methods = { 
         @ServiceMethod(name = "GET", 
             description = {
                 ...
                 "Virtual Resource Provieder = org.sakaiproject.nakamura.resource.VirtualResourceProviderImpl@45e7c2\n"+
                 ...
                 "Virtual Resource Provieder Types Map = {sakai/personalPrivate=org.sakaiproject.nakamura.personal.resource." +
                 "PersonalResourceTypeProvider@27f9d5, sakai/contactstore=org.sakaiproject.nakamura.connections.resource." +
                 "ConnectionResourceTypeProvider@833478, sakai/messagestore=org.sakaiproject.nakamura.message.resource." +
                 "MessageResourceTypeProvider@e9e345, sakai/groupPublic=org.sakaiproject.nakamura.personal.resource." +
                 "GroupPublicResourceTypeProvider@47d6de, sakai/files=org.sakaiproject.nakamura.files.resource." +
                 "MessageResourceTypeProvider@6b8fa1, sakai/personalPublic=org.sakaiproject.nakamura.personal.resource." +
