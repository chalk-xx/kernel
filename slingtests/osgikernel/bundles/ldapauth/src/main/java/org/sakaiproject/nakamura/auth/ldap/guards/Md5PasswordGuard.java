 ...
 */
package org.sakaiproject.nakamura.auth.ldap.guards;
...
public class Md5PasswordGuard implements PasswordGuard {
  ...
  /**
   * {@inheritDoc}
   * @see org.sakaiproject.nakamura.api.auth.ldap.PasswordGuard#guard(java.lang.String)
   */
  public String guard(String password) {
    String guarded = DigestUtils.md5Hex(password);
    return guarded;
  }
