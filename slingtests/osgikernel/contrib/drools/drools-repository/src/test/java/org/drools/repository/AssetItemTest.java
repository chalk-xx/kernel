...
//    	System.err.println(asset[1]);
    ...
    public void testUpdateContent() throws Exception {
            ...
            VersionManager versionManager = ruleItem1.getNode().getSession().getWorkspace().getVersionManager();
            VersionIterator it = versionManager.getVersionHistory(ruleItem1.getNode().getPath()).getAllVersions();
    ...
    public void testCategories() {
        ...
        List<CategoryItem> tags = ruleItem1.getCategories();
        ...
        List<AssetItem> result = getRepo().findAssetsByCategory("testAddTagTestTag", 0, -1).assets;
    ...
    public void testUpdateCategories() {
        ...
        for ( Iterator<CategoryItem> iter = item.getCategories().iterator(); iter.hasNext(); ) {
            CategoryItem cat = iter.next();
    ...
    public void testFindRulesByCategory() throws Exception {
        ...
        List<AssetItem> rules = getRepo().findAssetsByCategory( "testFindRulesByCat", 0, -1 ).assets;
        assertEquals(2, rules.size());

        for ( Iterator<AssetItem> iter = rules.iterator(); iter.hasNext(); ) {
    ...
    public void testGetSuccessorVersionsIterator() {
        try {
            ...
            Iterator<VersionableItem> iterator = ruleItem1.getSuccessorVersionsIterator();
    ...
    public void testGetPredecessorVersionsIterator() {
            ...
            Iterator<VersionableItem> iterator = ruleItem1.getPredecessorVersionsIterator();
            assertNotNull(iterator);
            assertFalse(iterator.hasNext());
    ...
    public void testHistoryIterator() throws Exception {
        ...
        Iterator<AssetItem> it = ruleItem1.getHistory();
        for ( int i = 0; i < 2; i++ ) {
            assertTrue(it.hasNext());
            it.next();
        }
