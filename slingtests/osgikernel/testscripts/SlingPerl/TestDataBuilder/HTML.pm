...
sub header_html {
    return start_html(-title=>'Created by TestDataBuilder::HTML',
                      -author=>'Daniel Parry',
		      -base=>'true',
		      -target=>'_blank',
		      -meta=>{'keywords'=>'Test Data Builder', 'copyright'=>'copyright 2009 Daniel Parry'},
                      -BGCOLOR=>'blue');
}
#}}}
