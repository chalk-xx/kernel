...
public class ListVersionsServletHandler extends AbstractSafeMethodsServletResourceHandler {
  ...
  */
   ...
   * @return
   */
  public long[] getInvertedRange(long total, int offset, int nitems) {
