...
@Properties({
    ...
    @Property(name = "sakai.search.provider", value = "PooledContentSparse") })
public class ContentPoolSparseSearchPropertyProvider implements SolrSearchPropertyProvider {

  public static final Logger LOGGER = LoggerFactory
      .getLogger(ContentPoolSparseSearchPropertyProvider.class);
