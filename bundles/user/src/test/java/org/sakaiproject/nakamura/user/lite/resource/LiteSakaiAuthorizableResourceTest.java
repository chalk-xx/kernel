 ...
 *
 */
public class LiteSakaiAuthorizableResourceTest {
  ...
  public void test() throws AccessDeniedException, StorageClientException {
    ...
    LiteAuthorizableResource s = new LiteAuthorizableResource(ieb, resourceResolver, "/user");
    LiteAuthorizableValueMap m = (LiteAuthorizableValueMap) s.adaptTo(ValueMap.class);
