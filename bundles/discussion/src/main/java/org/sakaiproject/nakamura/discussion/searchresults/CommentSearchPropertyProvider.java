...
@Properties({
    ...
    @Property(name = "service.description", value = "Translates an external comment path to a Node path for searching."),
    @Property(name = "sakai.search.provider", value = "Comment") })
public class CommentSearchPropertyProvider implements SolrSearchPropertyProvider {
