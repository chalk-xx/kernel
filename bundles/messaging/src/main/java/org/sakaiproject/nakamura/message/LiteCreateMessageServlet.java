...
public class LiteCreateMessageServlet extends SlingAllMethodsServlet {
  ...
  protected void doPost(SlingHttpServletRequest request,
    ...
    try {
      ...
      path = msg.getPath();
      messageId = msg.getProperty(MessageConstants.PROP_SAKAI_ID).toString();
    ...
    try {
      ...
      Content messageNode = contentManager.get(path);
