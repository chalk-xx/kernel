...
class TC_RSSTest < Test::Unit::TestCase
  ...
  def test_regular_file
    ...
    assert_equal(400, res.code.to_i, "This is not an XML file. Service should return 403."+res.body)
  end
  ...
  def test_big_file
    ...
    assert_equal(400, res.code.to_i, "This file is way to big. Service should return 403"+res.body)
  end
