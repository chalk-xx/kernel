...
class TC_Kern854 < Test::Unit::TestCase
  ...
  def test_widgetlisting
    ...
    @s.create_file_node(widgetsPath + "/good-#{m}/bundles", "good-#{m}", "en_UK.properties", "WELCOME=Welcome", "text/plain")
    @s.create_file_node(widgetsPath + "/good-#{m}/bundles", "good-#{m}", "nl_BE.properties", "WELCOME=Welkom", "text/plain")
    @s.create_file_node(widgetsPath + "/good-#{m}/bundles", "good-#{m}", "fr_BE.properties", "WELCOME=Bienvenue", "text/plain")
    ...
    assert_equal("WELCOME=Welkom", json["bundles"]["nl_BE"])
