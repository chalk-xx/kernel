...
class TC_Kern1024Test < Test::Unit::TestCase
  ...
  def test_members_servlet_from_group_manager
    ...
    res = @s.execute_get(@s.url_for("/system/lite/userManager/group/#{group.name}.members.json"))
    ...
    res = @s.execute_get(@s.url_for("/system/lite/userManager/group/#{group.name}.managers.json"))
