 ...
 */
package org.sakaiproject.nakamura.xythos.docproxy;
...
public class XythosDocumentResult implements ExternalDocumentResult {
  ...
  private String uri;
  private XythosRepository xythosService;

  @SuppressWarnings("unchecked")
  public XythosDocumentResult(Map<String, Object> document, XythosRepository xythosService) {
    if (document != null) {
      ...
      if (document.containsKey("properties")) {
        ...
        if (this.properties.containsKey("thumbnailUri")) {
          this.properties.put("thumbnailUri",
              "/xythos" + (String) this.properties.get("thumbnailUri"));
        }
      }
