...
@Service(value = XythosRepository.class)
@Properties(value = {
    ...
    @Property(name = "repository.type", value = "xythos")})
public class HessianXythosRemote implements XythosRepository {
  ...
  protected void activate(ComponentContext context) {
    ...
    try {
      ...
      xythosService = (XythosRepository) factory.create(XythosRepository.class,
