...
public class PackageItem extends VersionableItem {
    private static Logger      log                              = LoggerFactory.getLogger( PackageItem.class );
...
//    }
    ...
    public Iterator<AssetItem> getAssetsWithStatus(final StateItem state, final StateItem ignoreState) {
        final Iterator<AssetItem> rules = getAssets();
        ...
        while(rules.hasNext()) {
            ...
            if (head.sameState( state )) {
                ...
                List<AssetItem> fullHistory = new ArrayList<AssetItem>();
                ...
                Iterator<AssetItem> prev = fullHistory.iterator();
                while (prev.hasNext()) {
    ...
    void sortHistoryByVersionNumber(List<AssetItem> fullHistory) {
        Collections.sort( fullHistory, new Comparator<AssetItem>() {
          ...
          public int compare(AssetItem o1,
              AssetItem o2) {
              long la1 = o1.getVersionNumber();
              long la2 = o2.getVersionNumber();
              if (la1 == la2) return 0;
...
//    }
    ...
    private static Map<String, String> convertFromObjectGraphs(final String[] keys, final String[] values){
    ...
    public Map<String,String> getCategoryRules(){
