...
public class RulesRepository {
    ...
    protected static Node addNodeIfNew(Node parent,
        ...
        try {
            ...
            try {
                log.debug( new StringBuilder().append( "Adding new node of type: " ).append( type ).append( " named: " ).append( nodeName ).append( " to parent node named " ).append( parent.getName() ).toString() );
    ...
    public String renamePackage(String uuid,
        ...
        try {
            ...
            for ( Iterator<AssetItem> iter = newPkg.getAssets(); iter.hasNext(); ) {
