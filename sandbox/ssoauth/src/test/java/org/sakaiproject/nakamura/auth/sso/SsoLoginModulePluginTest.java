...
import org.sakaiproject.nakamura.auth.sso.SsoAuthenticationHandler.SsoPrincipal;
 ...
 *
 */
public class SsoLoginModulePluginTest {
  SsoLoginModulePlugin plugin;

  SimpleCredentials credentials;

  @Before
  public void setUp() throws Exception {
    plugin = new SsoLoginModulePlugin();
