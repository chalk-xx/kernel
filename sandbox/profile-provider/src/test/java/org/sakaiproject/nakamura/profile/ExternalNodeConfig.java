...
public class ExternalNodeConfig {
  ...
  public static ExternalNodeConfig configExternal(Node externalNode, String nodeName, String path,
    ...
    Mockito.when(externalNode.getSession()).thenReturn(session);
    ...
    Mockito.when(settingsNode.getProperty("sakai:provider")).thenReturn(providerProperty);
    Mockito.when(providerProperty.getString()).thenReturn(providerName,providerConfigPath);
    Mockito.when(settingsNode.getProperty("sakai:provider-settings")).thenReturn(providerProperty);
